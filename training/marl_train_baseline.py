"""
MARL training/evaluation with baseline (non-LLM) communication for EMCOM-X.
"""
...
def main():
    """Runs MARL with baseline (dense/zero) comm integration."""
    ...
    for episode in range(num_episodes):
        ...
        while not all(done.values()):
            ...
            for agent in agent_ids:
                ...
                # Optionally, use your dense commnet head here if not zeros
        ...
        logger.info(f"Baseline Episode {episode + 1}/{num_episodes} finished.")
